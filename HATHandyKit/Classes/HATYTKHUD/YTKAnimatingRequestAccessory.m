...
- (void)requestWillStart:(id)request {
    if (_animatingView || _animatingText) {
        dispatch_async(dispatch_get_main_queue(), ^{
            ...
            _loadingView = [HACMBProgressHUD showHUDAddedTo:[UIApplication sharedApplication].delegate.window animated:YES];
            ...
            _loadingView.leftMargin = kMessageView_LeftMargin;
