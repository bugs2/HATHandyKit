...
// 常量
/** 密码框的高度 */
UIKIT_EXTERN  CGFloat CYPasswordInputViewHeight;
/** 键盘的高度 */
UIKIT_EXTERN  CGFloat CYPasswordKeyboardHeight;
/** 密码框标题的高度 */
UIKIT_EXTERN  CGFloat CYPasswordViewTitleHeight;
/** 密码框显示或隐藏时间 */
UIKIT_EXTERN  CGFloat CYPasswordViewAnimationDuration;
/** 关闭按钮的宽高 */
UIKIT_EXTERN  CGFloat CYPasswordViewCloseButtonWH;
/** 关闭按钮的左边距 */
UIKIT_EXTERN  CGFloat CYPasswordViewCloseButtonMarginLeft;
/** 输入点的宽高 */
UIKIT_EXTERN  CGFloat CYPasswordViewPointnWH;
/** TextField图片的宽 */
UIKIT_EXTERN  CGFloat CYPasswordViewTextFieldWidth;
/** TextField图片的高 */
UIKIT_EXTERN  CGFloat CYPasswordViewTextFieldHeight;
/** TextField图片向上间距 */
UIKIT_EXTERN  CGFloat CYPasswordViewTextFieldMarginTop;
/** 忘记密码按钮向上间距 */
UIKIT_EXTERN  CGFloat CYPasswordViewForgetPWDButtonMarginTop;
